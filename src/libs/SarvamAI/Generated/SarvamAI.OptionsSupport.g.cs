...
namespace SarvamAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::SarvamAI.AutoSDKRetryOptions Retry { get; set; } = new global::SarvamAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::SarvamAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::SarvamAI.IAutoSDKHook>();
        ...
        public global::SarvamAI.AutoSDKClientOptions AddHook(
            global::SarvamAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::SarvamAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::SarvamAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::SarvamAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::SarvamAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::SarvamAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::SarvamAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::SarvamAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::SarvamAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::SarvamAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::SarvamAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::SarvamAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::SarvamAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::SarvamAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::SarvamAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::SarvamAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::SarvamAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::SarvamAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::SarvamAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::SarvamAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::SarvamAI.AutoSDKClientOptions clientOptions,
            global::SarvamAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::SarvamAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::SarvamAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::SarvamAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::SarvamAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::SarvamAI.IAutoSDKHook, global::SarvamAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::SarvamAI.AutoSDKHookContext context)
        {
